...
const Api = {
  ...
  getPrefetch: () => {
    ...
    return NetworkLayer.get({
      service: URL.prefetch,
      data: {},
      options: { headers },
    });
  },
  ...
  corporateUserSearch: (params: CorporateUserAutosuggest) => {
    ...
    return NetworkLayer.get({
      service: URL.corporateUserSearch,
      data: { ...params },
      options: { headers },
    });
  },
  ...
  editGstAuthorisation: () => {
    ...
    return NetworkLayer.get({
      service: URL.editGstAuthorisation,
      data: {},
      options: { headers },
    });
  },
  cancelModificationRequest: (params: BookingIdPayload) => {
    ...
    const url = URL.cancelModificationRequest.replace(
      '${bookingId}',
      params.bookingId,
    );
